...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-BASE-v0",
    entry_point="legged_lab.envs:ManagerBasedAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.g1_amp_base_env_cfg:G1AmpBaseEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_base_cfg:G1RslRlOnPolicyRunnerAmpBaseCfg",
    },
)

gym.register(
    id="LeggedLab-Isaac-AMP-G1-BASE-Play-v0",
    entry_point="legged_lab.envs:ManagerBasedAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.g1_amp_base_env_cfg:G1AmpBaseEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_base_cfg:G1RslRlOnPolicyRunnerAmpBaseCfg",
    },
)
